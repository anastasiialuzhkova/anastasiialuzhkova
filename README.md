...
I’ve been working as a Software Quality Assurance Engineer since December 2024.
In my current role, I focus on API testing and writing automated tests using Node.js.  
I enjoy building reliable test coverage, improving quality processes, and constantly learning new tools in the automation ecosystem.

## About me

☘️ QA Engineer since 2024  
⚙️ API testing & test automation (Node.js)  
📚 Actively developing my JavaScript and automation skills  
🧩 My training and personal projects are available on GitHub  
🧘‍♀️ Outside of tech I enjoy yoga, roller skating, and even handstanding
...
<img src="assets/swagger.svg" title="Swagger" alt="Swagger" width="40" height="40"/>
<div>
...
- Web application testing
  ...
  Web UI testing (training project)
...
- Programming
  ...
  - [UI Login Automation Tests (WebdriverIO)](https://github.com/anastasiialuzhkova/Epam_webdriver)
